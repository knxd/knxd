...
L_Data_PDU *CEMI_to_L_Data (const CArray & data, Layer2Interface * l2);

L_Busmonitor_PDU *CEMI_to_Busmonitor (const CArray & data, Layer2Interface * l2);
...
L_Data_PDU *EMI_to_L_Data (const CArray & data, Layer2Interface * l2);
